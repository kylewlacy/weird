...
function getRustOutput(file, styxCLI) {
    try {
...
function parseErrorSpan(output) {
...
function annotateSpan(source, start, end, msg) {
...
function annotateErrorDiff(source, jsOutput, rustOutput) {
    ...
    for (const file of files) {
        ...
        it(relPath, () => {
            ...
            if (jsNorm !== rustNorm) {
                ...
                assert.fail(`Output mismatch${annotation}\n--- JS output ---\n${jsOutput}\n--- Rust output ---\n${rustOutput}`);
            }
        });
    }
});
